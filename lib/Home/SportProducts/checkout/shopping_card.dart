              ...
              return Scaffold(
                ...
                body: Column(
                  children: [
                    Expanded(
                      child: ListView(
                        children: new List.generate(cubit.products.length, (index)=> Column(
                          children: [
                            Padding(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          Row(
                                            children: [
                                              Container(
                                                child: Text('${cubit.products[index]['Name']}',maxLines: 2,
                                                  style: TextStyle(
                                                    fontSize: 14,
                                          ...
                                          Text('${cubit.products[index]['Brand']}',
                                            style: TextStyle(
                                          ...
                                          Padding(
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                InkWell(
                                                  onTap: (){
                                                    cubit.changeCounterMinus(index);
                                                    // setState(() {
                                                ...
                                                Container(
                                                  ...
                                                  child: Center(child:Text('${cubit.products[index]['Counter']}'),),
                                                ),
                                                InkWell(
                                                  onTap: (){

                                                    cubit.changeCounterPlus(index);
                                                  },
                                                  child: Container(
                                                      height: 16,
                                                      width: 24,
